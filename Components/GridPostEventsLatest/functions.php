...
namespace Flynt\Components\GridPostEventsLatest;
...
add_filter('Flynt/addComponentData?name=GridPostEventsLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'gridPostEventsLatest',
        'label' => 'Grid: Upcoming Events',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridPostEventsLatest', [
    [
