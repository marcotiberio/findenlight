...
namespace Flynt\Components\GridPostsContributorsLatest;
...
add_filter('Flynt/addComponentData?name=GridPostsContributorsLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'gridPostsContributorsLatest',
        'label' => 'Grid: Contributors',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridPostsContributorsLatest', [
    [
