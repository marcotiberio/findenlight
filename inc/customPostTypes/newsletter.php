...
function registerNewslettersPostType()
{
    $labels = [
        'name'                  => _x('Member Newsletters', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Member Newsletter', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Member Newsletters', 'flynt'),
        'name_admin_bar'        => __('Member Newsletter', 'flynt'),
    ...
    $args = [
        'label'                 => __('Member Newsletter', 'flynt'),
        'description'           => __('Member Newsletter Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerNewslettersPostType');
